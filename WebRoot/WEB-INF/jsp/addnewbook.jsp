...
<%@ include file="header.jsp"%>
			<div class="main-content">
				...
				<c:choose>
			   	<c:when test="${requestScope.bookAddHuixian==null }">
			   		<div class="main-content-inner">
					...
					<form class="form-horizontal" role="form" action=${pageContext.request.contextPath}/servlet/AddNewBookServlet method=post>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="bid" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="publication" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-group">
