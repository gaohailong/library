						...
						<div class="login-container" style="margin-top: 60px;">
							<div class="center">
								...
								<h1>
									...
									<span class="red">小型</span>
									<span class="white" id="id-text2">图书馆管理系统</span>
								</h1>
							</div>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="uid" value="${formBean.uid}" class="form-control" placeholder="请输入学号" />${formBean.errors.uid}${errorMsg}
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="tel" value="${formBean.tel}" class="form-control" placeholder="请输入电话" />${formBean.errors.tel}
